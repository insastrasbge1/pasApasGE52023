 ...
 * @author francois
 */
public class PartageStaticSynchronisationClasse {
    ...
    public static class Incrementeur implements Runnable {
        ...
        public void run() {
            for (int i = 0; i < 100000000; i++) {
                synchronized (PartageStaticSynchronisationClasse.class) {
                    PartageStaticSynchronisationClasse.partage++;
                }
            }
        }
    }
    ...
    public static void test() {
        ...
        PartageStaticSynchronisationClasse.partage = 0;
        ...
        System.out.println("valeur finale : " + PartageStaticSynchronisationClasse.partage);
